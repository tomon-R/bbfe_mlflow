...
../surface/surf_dbc_sups 4 0.0 0.0 0.0 -1 -ie surf_left.dat  -o D_bc_vx1.dat
../surface/surf_dbc_sups 4 0.0 0.0 0.0 -1 -ie surf_right.dat  -o D_bc_vx2.dat
../surface/surf_dbc_sups 4 0.0 0.0 0.0 -1 -ie surf_front.dat  -o D_bc_vy1.dat
../surface/surf_dbc_sups 4 0.0 0.0 0.0 -1 -ie surf_back.dat  -o D_bc_vy2.dat
../surface/surf_dbc_sups 4 0.0 0.0 0.0 -1 -ie surf_bottom.dat  -o D_bc_vz1.dat
../surface/surf_dbc_sups 4 0.0 0.0 0.0 -1 -ie surf_top.dat  -o D_bc_vz2.dat
...
OPTION=1
x_min=0
x_max=$(echo "scale=5; $4 / 4.0" | bc)
y_min=0
y_max=$5
z_min=0
z_max=$(echo "scale=5; $x_max * 2" | bc)
...
DIR_NAME="Dambreak_allnoslip_"$1"_"$2"_"$3"_"$4"_"$5"_"$6
